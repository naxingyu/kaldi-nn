...
parser.add_option('--bool-projected', dest='bool_projected', action='store_true',
                   help='Use projected LSTM, choosing false ignores --num-recurrent [default: %default]');
...
if o.num_layers == 1:
    if o.bool_projected == True:
        ...
        print "<LstmStreams> <InputDim> %d <OutputDim> %d <ParamScale> %f <ClipGradient> %f" % \
            (feat_dim, o.num_cells, o.lstm_stddev_factor, o.clip_gradient)
elif o.num_layers == 2:
    if o.bool_projected == True:
        print "<LstmProjectedStreams> <InputDim> %d <OutputDim> %d <CellDim> %s <ParamScale> %f <ClipGradient> %f" % \
            (feat_dim, o.num_recurrent, o.num_cells, o.lstm_stddev_factor, o.clip_gradient)
        ...
        print "<LstmStreams> <InputDim> %d <OutputDim> %d <ParamScale> %f <ClipGradient> %f" % \
            (feat_dim, o.num_cells, o.lstm_stddev_factor, o.clip_gradient)
        print "<LstmStreams> <InputDim> %d <OutputDim> %d <ParamScale> %f <ClipGradient> %f" % \
            (o.num_cells, o.num_cells, o.lstm_stddev_factor, o.clip_gradient)
else:
...
if o.bool_projected == True:
    ...
    print "<AffineTransform> <InputDim> %d <OutputDim> %d <BiasMean> 0.0 <BiasRange> 0.0 <ParamStddev> %f" % \
        (o.num_cells, num_leaves, o.param_stddev_factor)
