...
# train_relu_accel2.sh is modified from train_pnorm_accel2.sh
# 2015 Xingyu Na
...
AffineComponentPreconditionedOnline input-dim=$lda_dim output-dim=$hidden_dim $online_preconditioning_opts learning-rate=$initial_lrate param-stddev=$stddev bias-stddev=$bias_stddev
